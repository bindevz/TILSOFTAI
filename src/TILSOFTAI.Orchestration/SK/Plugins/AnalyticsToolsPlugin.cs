...
public sealed class AnalyticsToolsPlugin
{
    ...
    public Task<object> RunAsync(
        ...
        => _invoker.ExecuteAsync("analytics.run", new { datasetId, pipeline, topN, maxGroups, maxResultRows, persistResult }, ToolExposurePolicy.AllowedTools, ct);
    ...
    public Task<object> AtomicCatalogSearchAsync(
        ...
        int topK = 5,
        CancellationToken ct = default)
        => _invoker.ExecuteAsync("atomic.catalog.search", new { query, topK }, ToolExposurePolicy.AllowedTools, ct);
    ...
    public Task<object> AtomicQueryExecuteAsync(
        ...
        => _invoker.ExecuteAsync("atomic.query.execute", new
        {
            ...
            maxDisplayRows,
            previewRows
        }, ToolExposurePolicy.AllowedTools, ct);
}
